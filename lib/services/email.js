    ...
    <div style="padding:32px 28px;background:#0A1714">
      ...
      <div style="background:rgba(26,107,94,.1);border:1px solid rgba(26,107,94,.3);border-radius:12px;padding:20px;margin-bottom:24px">
        ...
        <table style="width:100%;border-collapse:collapse">
          ...
          <tr><td style="color:rgba(240,245,244,.55);font-size:13px;padding:4px 0">NPI</td><td style="color:#F0F5F4;font-size:13px">${lead.npi || '-'}</td></tr>
          <tr><td style="color:rgba(240,245,244,.55);font-size:13px;padding:4px 0">Speciality</td><td style="color:#F0F5F4;font-size:13px">${lead.speciality || '-'}</td></tr>
